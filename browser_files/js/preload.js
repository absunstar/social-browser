        ...
        if ((loadLOADED = true)) {
            ...
            if (SOCIALBROWSER.defaultUserAgent) {
                ...
                if (SOCIALBROWSER.defaultUserAgent.vendor) {
                    navigator.vendor = SOCIALBROWSER.defaultUserAgent.vendor;
                }

                if (SOCIALBROWSER.defaultUserAgent.platform) {
                    navigator.platform = SOCIALBROWSER.defaultUserAgent.platform;
                }
            }
            ...
            navigator.userAgent = SOCIALBROWSER.userAgentURL;
            ...
            (function loadFingerPrint() {
                if ((fingerPrintLOADED = true)) {
                    ...
                    if (SOCIALBROWSER.session.privacy.vpc.hide_lang) {
                        ...
                        SOCIALBROWSER.__define(navigator, 'language', SOCIALBROWSER.session.privacy.vpc.languages.split(',')[0].split(';')[0]);
