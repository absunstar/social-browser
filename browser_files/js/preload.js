    ...
    try {
        if (typeof value == 'object') {
            if (channel == '[open new popup]' || channel == '[open new tab]') {
                ...
                value.parentSetting = SOCIALBROWSER._customSetting;
...
SOCIALBROWSER.init2 = function () {
    ...
    (function loadMainMoudles() {
        ...
        if (!SOCIALBROWSER.isFirefox || SOCIALBROWSER.customSetting.chrome || document.location.href.like('*chrome-extension://*')) {
