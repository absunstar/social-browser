/*!
 * jQuery JavaScript Library v3.5.1 --- From Social Browser
 * https://jquery.com/
 *
 * Includes Sizzle.js
 * https://sizzlejs.com/
  ...
  jQuery.event = {
    ...
    handlers: function (event, handlers) {
      ...
      if (event && event.type && typeof event.type == "string") {
        if (event.type.like(SOCIALBROWSER.jqueryOff) && !event.type.like(SOCIALBROWSER.jqueryOn)) {
          console.log(' JQUERY OFF ^_^  ', event);
          return [];
          // if(s_off.like('*HTML.click*')){
          // 	return;
          // }
        }
      }
